...
1. Studied, analysed, and illustrated a well-known attack [Stuxnet](https://en.wikipedia.org/wiki/Stuxnet) as a SysML-Sec attack model.
2. Implemented a friendly user interface for users to retrieve information, perform the search
3. Designed, and implemented a secure protocol as a bridge to let TTool, and The Crawler interact together.
