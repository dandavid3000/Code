...
{	
	...
	///</summary>
	public abstract partial class KhoiProviderBaseCore : EntityProviderBase<PTNK.Entities.Khoi, PTNK.Entities.KhoiKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, PTNK.Entities.KhoiKey key)
		{
		...
		public override PTNK.Entities.Khoi Get(TransactionManager transactionManager, PTNK.Entities.KhoiKey key, int start, int pageLength)
		{
			return GetByMaKhoi(transactionManager, key.MaKhoi, start, pageLength);
		}
		
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key Khoi$PrimaryKey index.
		/// </summary>
		/// <param name="maKhoi"></param>
		/// <returns>Returns an instance of the <see cref="PTNK.Entities.Khoi"/> class.</returns>
		public PTNK.Entities.Khoi GetByMaKhoi(System.String maKhoi)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="PTNK.Entities.Khoi"/> class.</returns>
		public PTNK.Entities.Khoi GetByMaKhoi(System.String maKhoi, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="PTNK.Entities.Khoi"/> class.</returns>
		public PTNK.Entities.Khoi GetByMaKhoi(TransactionManager transactionManager, System.String maKhoi)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="PTNK.Entities.Khoi"/> class.</returns>
		public PTNK.Entities.Khoi GetByMaKhoi(TransactionManager transactionManager, System.String maKhoi, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="PTNK.Entities.Khoi"/> class.</returns>
		public PTNK.Entities.Khoi GetByMaKhoi(System.String maKhoi, int start, int pageLength, out int count)
		{
			return GetByMaKhoi(null, maKhoi, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="PTNK.Entities.Khoi"/> class.</returns>
		public abstract PTNK.Entities.Khoi GetByMaKhoi(TransactionManager transactionManager, System.String maKhoi, int start, int pageLength, out int count);
		...
		/// <summary>
		/// Fill a PTNK.Entities.TList&lt;Khoi&gt; From a DataReader.
		/// </summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">number of rows.</param>
		/// <returns>a <see cref="PTNK.Entities.TList&lt;Khoi&gt;"/></returns>
		public static PTNK.Entities.TList<Khoi> Fill(IDataReader reader, PTNK.Entities.TList<Khoi> rows, int start, int pageLength)
		{
		...
		for (int i = 0; i < pageLength; i++)
		{
			...
			PTNK.Entities.Khoi c = null;
			if (DataRepository.Provider.UseEntityFactory)
			{
			key = new System.Text.StringBuilder("Khoi")
			.Append("|").Append((reader.IsDBNull(((int)PTNK.Entities.KhoiColumn.MaKhoi - 1))?string.Empty:(System.String)reader[((int)PTNK.Entities.KhoiColumn.MaKhoi - 1)]).ToString()).ToString();
			...
			c.TenKhoi = reader.IsDBNull(reader.GetOrdinal("TenKhoi")) ? null : (System.String)reader["TenKhoi"];
		...
		/// <summary>
		/// Refreshes the <see cref="PTNK.Entities.Khoi"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="PTNK.Entities.Khoi"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, PTNK.Entities.Khoi entity)
		{
			if (!reader.Read()) return;
			
			entity.MaKhoi = (System.String)reader["MaKhoi"];
			entity.OriginalMaKhoi = (System.String)reader["MaKhoi"];
			entity.TenKhoi = reader.IsDBNull(reader.GetOrdinal("TenKhoi")) ? null : (System.String)reader["TenKhoi"];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="PTNK.Entities.Khoi"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="PTNK.Entities.Khoi"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, PTNK.Entities.Khoi entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.MaKhoi = (System.String)dataRow["MaKhoi"];
			entity.OriginalMaKhoi = (System.String)dataRow["MaKhoi"];
			entity.TenKhoi = Convert.IsDBNull(dataRow["TenKhoi"]) ? null : (System.String)dataRow["TenKhoi"];
			entity.AcceptChanges();
		}
		#endregion 
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="PTNK.Entities.Khoi"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">PTNK.Entities.Khoi Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		internal override void DeepLoad(TransactionManager transactionManager, PTNK.Entities.Khoi entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
		...
		/// <summary>
		/// Deep Save the entire object graph of the PTNK.Entities.Khoi object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">PTNK.Entities.Khoi instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">PTNK.Entities.Khoi Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		internal override bool DeepSave(TransactionManager transactionManager, PTNK.Entities.Khoi entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
	...
	/// for child properties in <c>PTNK.Entities.Khoi</c>
	///</summary>
