...
{		
	...
	public partial class MonHocServiceBase : ServiceBase<MonHoc, MonHocKey>
	{
		...
		public static MonHoc CreateMonHoc(System.String maMonHoc, System.String tenMonHoc, System.Byte? quiDinhSoTietHocLienTiepToiThieu, System.Byte? quiDinhSoTietHocLienTiepToiDa)
		{
			MonHoc newEntityMonHoc = new MonHoc();
			newEntityMonHoc.MaMonHoc  = maMonHoc;
			newEntityMonHoc.TenMonHoc  = tenMonHoc;
			newEntityMonHoc.QuiDinhSoTietHocLienTiepToiThieu  = quiDinhSoTietHocLienTiepToiThieu;
			newEntityMonHoc.QuiDinhSoTietHocLienTiepToiDa  = quiDinhSoTietHocLienTiepToiDa;
		...
		/// <summary>
		///  method that Gets rows in a <see cref="TList{MonHoc}" /> from the datasource based on the primary key MonHoc$PrimaryKey index.
		/// </summary>
		/// <param name="maMonHoc"></param>
		/// <returns>Returns an instance of the <see cref="MonHoc"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual MonHoc GetByMaMonHoc(System.String maMonHoc)
		{
			int totalCount = -1;
		...
		/// <returns>Returns an instance of the <see cref="MonHoc"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual MonHoc GetByMaMonHoc(System.String maMonHoc, int start, int pageLength, out int totalCount)
		{
            ...
            {	
				...
				//Access Repository
				entity = dataProvider.MonHocProvider.GetByMaMonHoc(transactionManager, maMonHoc, start, pageLength, out totalCount)   as MonHoc;
		...
		/// <returns>Returns true if operation suceeded.</returns>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual bool Delete(System.String maMonHoc)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			try
            {
				...
				//Delete
				result = dataProvider.MonHocProvider.Delete(transactionManager, maMonHoc);
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual MonHoc DeepLoadByMaMonHoc(System.String maMonHoc, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoadByMaMonHoc");		    
			bool isBorrowedTransaction = ConnectionScope.Current.HasTransaction;				
	
			MonHoc entity = GetByMaMonHoc(maMonHoc);
