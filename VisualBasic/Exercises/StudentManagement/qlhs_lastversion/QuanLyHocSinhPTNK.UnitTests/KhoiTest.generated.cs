   ...
   public partial class KhoiTest
    {
        ...
        {		
			...
			System.Console.WriteLine("-- Testing the Khoi Entity with the {0} --", QuanLyHocSinhPTNK.Data.DataRepository.Provider.Name);
			System.Console.WriteLine(new String('-', 75));
        }
		...
		{		
			...
			mock.MaKhoi = "V[PLb3";
			mock.TenKhoi = "HWOSBORNZDZFDZUAZXIQATBL";
		...
		{
			mock.MaKhoi = "V[PL142";
			mock.TenKhoi = "HWOSBORNZDZFDZUAZXIQATBL2";
