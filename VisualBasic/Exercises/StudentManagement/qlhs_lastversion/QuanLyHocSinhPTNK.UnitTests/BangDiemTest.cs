...
namespace QuanLyHocSinhPTNK.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="BangDiemTest"/> instance.
		/// </summary>	
		public BangDiemTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  BangDiem objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public BangDiem CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            BangDiem mock = BangDiemTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, BangDiem mock)
        {
            BangDiemTest.UpdateMockInstance_Generated(tm, mock);
            // make any alterations necessary 
            // (i.e. for DB check constraints, special test cases, etc.)
        }
    }
