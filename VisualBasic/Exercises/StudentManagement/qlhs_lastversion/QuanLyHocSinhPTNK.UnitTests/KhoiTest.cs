...
namespace QuanLyHocSinhPTNK.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="KhoiTest"/> instance.
		/// </summary>	
		public KhoiTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  Khoi objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public Khoi CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            Khoi mock = KhoiTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, Khoi mock)
        {
            KhoiTest.UpdateMockInstance_Generated(tm, mock);
            // make any alterations necessary 
            // (i.e. for DB check constraints, special test cases, etc.)
        }
    }
