...
namespace QuanLyHocSinhPTNK.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="BangThamSoTest"/> instance.
		/// </summary>	
		public BangThamSoTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  BangThamSo objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public BangThamSo CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            BangThamSo mock = BangThamSoTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, BangThamSo mock)
        {
            BangThamSoTest.UpdateMockInstance_Generated(tm, mock);
            // make any alterations necessary 
            // (i.e. for DB check constraints, special test cases, etc.)
        }
    }
