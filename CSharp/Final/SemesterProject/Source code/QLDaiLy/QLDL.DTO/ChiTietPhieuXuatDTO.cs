...
namespace QLDL.DTO
{
    public class ChiTietPhieuXuatDTO
    {
        ...
        public ChiTietPhieuXuatDTO(int maphieuxuat, int mamathang, int madonvitinh, int dongiaxuat, int soluongxuat, int thanhtien)
        {
        ...
        public ChiTietPhieuXuatDTO(ChiTietPhieuXuatDTO temp)
        {

            _maphieuxuat = temp.Maphieuxuat;
            _mamathang = temp.Mamathang;
            _madonvitinh = temp.Madonvitinh;
            _dongiaxuat = temp.Dongiaxuat;
            _soluongxuat = temp.Soluongxuat;
            _thanhtien = temp.Thanhtien;
